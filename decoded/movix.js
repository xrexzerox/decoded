// ============================================
// DECODED: providers/movix.js
// Provider: Movix VF
// Original: English & French content
// ============================================

const cheerio = require('cheerio-without-node-native');
const TMDB_API_KEY = '439c478a771f35c05022f9feabcca01c';
const BASE_URL = 'https://movix.vf';
const USER_AGENT = 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36';

async function getStreams(tmdbId, type = 'movie', season = null, episode = null) {
  console.log('[Movix] Fetching: ' + tmdbId + ' type=' + type);
  try {
    ...
    while ((match = videoRegex.exec(pageHtml)) !== null) {
      ...
      streams.push({
        name: 'Movix | ' + quality.toUpperCase(),
        title: '🎬 Movix | ' + quality + '\n🎞️ MKV | ⚡ H.264',
        url: match[1],
        quality: '',
    ...
    console.error('[Movix] Error: ' + e.message);
    return [];
  }
}

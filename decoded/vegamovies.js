// ============================================
// DECODED: providers/vegamovies.js
// Provider: VegaMovies
// Original: High-quality direct link scraper
// ============================================

const cheerio = require('cheerio-without-node-native');
const TMDB_API_KEY = '439c478a771f35c05022f9feabcca01c';
const BASE_URL = 'https://vegamovies.pet';
const USER_AGENT = 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36';

async function getStreams(tmdbId, type = 'movie', season = null, episode = null) {
  console.log('[VegaMovies] Fetching: ' + tmdbId + ' type=' + type);
  try {
    ...
    while ((match = videoRegex.exec(pageHtml)) !== null) {
      ...
      streams.push({
        name: 'VegaMovies | ' + quality.toUpperCase(),
        title: '🎬 VegaMovies | ' + quality + '\n🎞️ MKV | ⚡ H.264',
        url: match[1],
        quality: '',
    ...
    console.error('[VegaMovies] Error: ' + e.message);
    return [];
  }
}

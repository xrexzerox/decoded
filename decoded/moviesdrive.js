// ============================================
// DECODED: providers/moviesdrive.js
...
const BASE_URL = 'https://moviesdrive.in';
const USER_AGENT = 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36';

async function getStreams(tmdbId, type = 'movie', season = null, episode = null) {
  console.log('[MoviesDrive] Fetching: ' + tmdbId + ' type=' + type);
  try {
    ...
    while ((match = videoRegex.exec(pageHtml)) !== null) {
      ...
      streams.push({
        name: 'MoviesDrive | ' + quality.toUpperCase(),
        title: '🎬 MoviesDrive | ' + quality + '\n🎞️ MKV | ⚡ H.264',
        url: match[1],
        quality: '',

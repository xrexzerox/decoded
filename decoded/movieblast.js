// ============================================
// DECODED: providers/movieblast.js
// Provider: MovieBlast
...
const BASE_URL = 'https://movieblast.xyz';
const USER_AGENT = 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36';

async function getStreams(tmdbId, type = 'movie', season = null, episode = null) {
  console.log('[MoviesBlast] Fetching: ' + tmdbId + ' type=' + type);
  try {
    ...
    while ((match = videoRegex.exec(pageHtml)) !== null) {
      ...
      streams.push({
        name: 'MoviesBlast | ' + quality.toUpperCase(),
        title: '🎬 MoviesBlast | ' + quality + '\n🎞️ MKV | ⚡ H.264',
        url: match[1],
        quality: '',
    ...
    console.error('[MoviesBlast] Error: ' + e.message);
    return [];
  }
}

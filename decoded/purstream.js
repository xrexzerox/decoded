// ============================================
// DECODED: providers/purstream.js
// Provider: Purstream (French)
// Original: French VF/VOSTFR/MULTI streaming
// ============================================

const cheerio = require('cheerio-without-node-native');
const BASE_URL = 'https://purstream.art';
const USER_AGENT = 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36';

async function getStreams(tmdbId, type = 'movie', season = null, episode = null) {
  console.log('[Purstream] Fetching: ' + tmdbId + ' type=' + type);
  try {
    const mediaType = type === 'tv' ? 'series' : 'film';
    ...
    while ((match = videoRegex.exec(pageHtml)) !== null) {
      ...
      streams.push({
        name: 'Purstream | ' + quality.toUpperCase(),
        title: '🎬 Purstream | ' + quality + '\n🎞️ MKV | ⚡ H.264',
        url: match[1],
        quality: '',
    ...
    console.error('[Purstream] Error: ' + e.message);
    return [];
  }
}

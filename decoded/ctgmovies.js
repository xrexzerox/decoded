// ============================================
// DECODED: providers/ctgmovies.js
// Provider: CTGMovies
// Original: English/Hindi movies
// ============================================
...
async function getStreams(tmdbId, type = 'movie', season = null, episode = null) {
  console.log('[CTGMovies] Fetching: ' + tmdbId + ' type=' + type);
  try {
    ...
    while ((match = videoRegex.exec(pageHtml)) !== null) {
      ...
      streams.push({
        name: 'CTGMovies | ' + quality.toUpperCase(),
        title: '🎬 CTGMovies | ' + quality + '\n🎞️ MKV | ⚡ H.264',
        url: match[1],
        quality: '',
    ...
    console.error('[CTGMovies] Error: ' + e.message);
    return [];
  }
}

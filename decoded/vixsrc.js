// ============================================
// DECODED: providers/vixsrc.js
// Provider: VixSrc
// Original: Embed-based with TMDB lookup
// ============================================

const TMDB_API_KEY = '439c478a771f35c05022f9feabcca01c';
const BASE_URL = 'https://vixsrc.cc';
const USER_AGENT = 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36';

async function getStreams(tmdbId, type = 'movie', season = null, episode = null) {
  console.log('[VixSrc] Fetching: ' + tmdbId + ' type=' + type);
  try {
    let embedUrl;
    ...
    while ((match = m3u8Regex.exec(html)) !== null) {
      ...
      streams.push({
        name: 'VixSrc | ' + quality.toUpperCase(),

// ============================================
// DECODED: providers/dahmermovies.js
// Provider: Dahmermovies
// Original: 1080p movie direct links
// ============================================
...
async function getStreams(tmdbId, type = 'movie', season = null, episode = null) {
  console.log('[Dahmermovies] Fetching: ' + tmdbId + ' type=' + type);
  try {
    ...
    while ((match = videoRegex.exec(pageHtml)) !== null) {
      ...
      streams.push({
        name: 'Dahmermovies | ' + quality.toUpperCase(),
        title: '🎬 Dahmermovies | ' + quality + '\n🎞️ MKV | ⚡ H.264',
        url: match[1],
        quality: '',

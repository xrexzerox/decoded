// ============================================
// DECODED: providers/movieshunt.js
// Provider: MoviesHunt
// Original: Hollywood & Bollywood multi-language
// ============================================

const cheerio = require('cheerio-without-node-native');
const TMDB_API_KEY = '439c478a771f35c05022f9feabcca01c';
const BASE_URL = 'https://movieshunt.in';
const USER_AGENT = 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36';

async function getStreams(tmdbId, type = 'movie', season = null, episode = null) {
  console.log('[MoviesHunt] Fetching: ' + tmdbId + ' type=' + type);
  try {
    ...
    while ((match = videoRegex.exec(pageHtml)) !== null) {
      ...
      streams.push({
        name: '🎬 MoviesHunt | ' + quality.toUpperCase(),
        title: '🎬 MoviesHunt | ' + quality + '\n🎞️ MKV | ⚡ H.264',
        url: match[1],
        quality: '',
    ...
    console.error('[MoviesHunt] Error: ' + e.message);
    return [];
  }
}

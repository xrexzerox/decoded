// ============================================
// DECODED: providers/einthusan.js
// Provider: Einthusan
// Original: 1080p Multi-language movies
// ============================================
...
async function getStreams(tmdbId, type = 'movie', season = null, episode = null) {
  console.log('[Einthusan] Fetching: ' + tmdbId + ' type=' + type);
  try {
    ...
    while ((match = videoRegex.exec(pageHtml)) !== null) {
      ...
      streams.push({
        name: 'Einthusan | ' + quality.toUpperCase(),
        title: '🎬 Einthusan | ' + quality + '\n🎞️ MKV | ⚡ H.264',
        url: match[1],
        quality: '',
    ...
    console.error('[Einthusan] Error: ' + e.message);
    return [];
  }
}
